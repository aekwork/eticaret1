                        ...
                        <form method="post">
                            <div class="row mb-10">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="country_name" required value="<?= $country['country_name']; ?>"
                            ...
                            <div class="row mb-10">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="country_short_code" required value="<?= $country['country_short_code']; ?>"
                                           class="form-control form-control-lg form-control-solid"
