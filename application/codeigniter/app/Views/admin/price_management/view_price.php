                        ...
                        <div class="row-mb-10 d-flex">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="price" id="price" class="form-control form-control-lg"
                                       placeholder="Fiyat" value="<?= $price['price']; ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row-mb-10 d-flex">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="price_preview" id="price_preview"
                                       class="form-control form-control-lg disabled" placeholder="Fiyat"
                        ...
                        <div class="d-flex pt-15">
                            <div class="me-5">
                                <a href="/admin/price-management/view/<?= $price_profile_id ?>"
                                   class="btn btn-lg btn-danger btn-active-primary">Geri Dön</a>
                            </div>
                        </div>
                    </div>
                ...
                function getProductFrameSizes() {
                    ...
                    xhr.onload = function () {
                        if (this.status === 200) {
                            ...
                            product_frame_size_input.innerHTML += '<option disabled>Seçiniz</option>';
                            product_sizes.forEach(function (product_size) {
                                if (product_size == "<?= $price['frame_size_id'] ?>") {
                                    product_frame_size_input.innerHTML += '<option value="' + product_size.id + '" selected' + product_size.size + 'tion>';
                                } else {
                ...
                function getProductFrameTypes() {
                    ...
                    xhr.onload = function () {
                        if (
                            ...
                            product_frame_type_input.innerHTML += '<option disabled>Seçiniz</option>';
                            frame_types.forEach(function (frame_type) {
                                    if (frame_type.frame_type_id == "<?= $price['frame_type_id'] ?>") {
                                        product_frame_type_input.innerHTML += '<option value="' + frame_type.frame_type_id + '" selected>' + (
                    ...
                    xhr.onload = function () {
                        if (
                            ...
                            product_colors.forEach(function (product_color) {
                                if (product_color.id == "<?= $price['frame_color_id'] ?>") {
                                    product_frame_color_input.innerHTML += '<option value="' + product_color.id + '" selected>' + product_color.color_name + '</option>';
                                } else {
